...
export type Medication={id:string;name:string;dosage:string;quantity:string;frequency:string;times_per_day:number;duration_days:number;start_date:string;instructions?:string;exact_times?:string[]}
